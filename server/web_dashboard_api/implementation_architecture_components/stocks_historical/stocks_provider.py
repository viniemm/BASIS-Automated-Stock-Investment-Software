...
class StocksDerivedModelProvider(BaseDerivedModelProvider):
    def __init__(self, filter_collection_provider, **kwargs):
        ...
        if derived_model_parser is None:
            derived_model_parser = StocksDerivedModelParser()
    ...
    def get_derived_model_list_from_json_filters(self, json_complex_filter_dict) -> [StocksDerivedModel]:
